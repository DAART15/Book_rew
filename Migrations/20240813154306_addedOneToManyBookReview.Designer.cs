...
namespace Book_rew.Migrations
{
    ...
    [Migration("20240813154306_addedOneToManyBookReview")]
    partial class addedOneToManyBookReview
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Book_rew.Models.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Author = "Dan Brown",
                            ISBN = "1234567890123",
                            PublishedTime = new DateTime(2024, 8, 13, 18, 43, 6, 553, DateTimeKind.Local).AddTicks(7400),
            ...
            modelBuilder.Entity("Book_rew.Models.Review", b =>
                {
                    b.HasOne("Book_rew.Models.Book", "Book")
                        .WithMany("Reviews")
